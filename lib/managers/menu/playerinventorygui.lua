-- chunkname: lib/managers/menu/playerinventorygui.lua
...
function PlayerInventoryGui:init(ws, fullscreen_ws, node)
	...
	var_5_1 = not player_loadout_data.melee_weapon.item_texture and {
		player_loadout_data.melee_weapon.dual_texture_1,
		player_loadout_data.melee_weapon.dual_texture_2
	}
	var_5_0.dual_image = var_5_1
	var_5_0.select_anim = select_anim
	var_5_0.unselect_anim = unselect_anim
	var_5_0.bg_color = Color.black:with_alpha(0.05)
	var_5_0.clbks = {
...
function PlayerInventoryGui:_update_loadout_boxes()
	...
	for box_name, entry in pairs(loadout_boxes) do
		...
		if box and player_loadout_data[entry] then
			local var_56_0 = self
			local var_56_1 = self.update_box
			local var_56_2 = box
			local var_56_3 = {
				bg_image = nil,
				dual_image = nil,
			...
			var_56_4 = not player_loadout_data[entry].item_texture and {
				player_loadout_data[entry].dual_texture_1,
				player_loadout_data[entry].dual_texture_2
			}
			var_56_3.dual_image = var_56_4
			var_56_3.bg_image = player_loadout_data[entry].item_bg_texture or false
			var_56_3.use_background = player_loadout_data[entry].item_bg_texture or false

			var_56_1(var_56_0, var_56_2, var_56_3, true)
		end
	end
...
function PlayerInventoryGui:previous_melee()
	...
	if box and managers.blackmarket:equip_previous_melee_weapon() then
		local player_loadout_data = managers.blackmarket:player_loadout_data()
		local var_74_0 = self
		local var_74_1 = self.update_box
		local var_74_2 = box
		local var_74_3 = {
			dual_image = nil,
			text = player_loadout_data.melee_weapon.info_text,
		...
		var_74_4 = not player_loadout_data.melee_weapon.item_texture and {
			player_loadout_data.melee_weapon.dual_texture_1,
			player_loadout_data.melee_weapon.dual_texture_2
		}
		var_74_3.dual_image = var_74_4

		var_74_1(var_74_0, var_74_2, var_74_3)
...
function PlayerInventoryGui:next_melee()
	...
	if box and managers.blackmarket:equip_next_melee_weapon() then
		local player_loadout_data = managers.blackmarket:player_loadout_data()
		local var_75_0 = self
		local var_75_1 = self.update_box
		local var_75_2 = box
		local var_75_3 = {
			dual_image = nil,
			text = player_loadout_data.melee_weapon.info_text,
		...
		var_75_4 = not player_loadout_data.melee_weapon.item_texture and {
			player_loadout_data.melee_weapon.dual_texture_1,
			player_loadout_data.melee_weapon.dual_texture_2
		}
		var_75_3.dual_image = var_75_4
